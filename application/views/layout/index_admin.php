    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('admin'); ?>">
                ...
                <div class="sidebar-brand-text mx-3">Kazastore Admin</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" aria-expanded="true" aria-controls="produk">
                    <i class="fas fa-fw fa-tshirt"></i>
                    <span>Produk</span>
                </a>
            </li>
            <!-- Nav Item - Pengguna Menu -->
            <li class="nav-item">
                <a class="nav-link" href="#" aria-expanded="true" aria-controls="produk">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" aria-expanded="true" aria-controls="order">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kazastore 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
